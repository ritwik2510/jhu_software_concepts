...
def run_analysis():
    ...
    with mlflow.start_run():
        ...
        tracked_model = KMeans(**params).fit(reduced)
        mlflow.log_metric("inertia", tracked_model.inertia_)
        mlflow.sklearn.log_model(tracked_model, "model", registered_model_name="Clustering")
